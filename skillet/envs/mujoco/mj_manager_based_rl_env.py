...
class MjManagerBasedRlEnv(SkilletGymEnv):
    ...
    def load_managers(self) -> None:
        ...
        self.reward_manager = RewardManager(self.cfg.rewards, self, scale_by_dt=self.cfg.scale_rewards_by_dt)
    ...
    def _configure_gym_env_spaces(self) -> None:
        ...
        for group_name, group_term_names in self.observation_manager.active_terms.items():
            ...
            if has_concatenated_obs:
                ...
                self.single_observation_space.spaces[group_name] = Box(shape=group_dim, low=-math.inf, high=math.inf)
            else:
                ...
                for term_name, term_dim, _term_cfg in zip(group_term_names, group_dim, group_term_cfgs, strict=False):
                    group_space.spaces[term_name] = Box(shape=term_dim, low=-math.inf, high=math.inf)
    ...
    def robot(self) -> Entity:
        ...
        if hasattr(self, "scene"):
            if hasattr(self.scene, "entities") and "robot" in self._env.scene.entities:
