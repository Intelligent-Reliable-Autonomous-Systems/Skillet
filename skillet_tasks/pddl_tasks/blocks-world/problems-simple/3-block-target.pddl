(define (problem three-block-table-stack)
    (:domain blocks)
    (:objects
        ...
        blue_target pink_target - target
        table0 - table
    )
    (:init
        ...
        (at-loc blue_target loc0)
        (at-loc blue_target loc1)
        (at-loc pink_target loc2)
        (at-loc pink_target loc3)
        (at-loc table0 loc4)
