...
from isaaclab_assets.robots.franka import FRANKA_PANDA_CFG, FRANKA_ROBOTIQ_GRIPPER_CFG  # isort: skip
...
class FrankaCubeLiftEnvCfg(LiftEnvCfg):
    def __post_init__(self):
        ...
        self.skills = ["reach_xyz", "orient_rpy", "gripper_oc"]
...
@configclass
class FrankaRobotIQCubeLiftEnvCfg(LiftEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        ...
        # self.scene.robot.init_state.pos = (0, 0)
