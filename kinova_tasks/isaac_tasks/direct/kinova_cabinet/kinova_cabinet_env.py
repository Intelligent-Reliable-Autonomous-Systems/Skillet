...
@configclass
class KinovaCabinetEnvCfg(KinovaBaseCfg):
    #
...
class KinovaCabinetEnv(DirectRLEnv):
    ...
    cfg: KinovaCabinetEnvCfg

    def __init__(self, cfg: KinovaCabinetEnvCfg, render_mode: str | None = None, **kwargs):
    ...
    def _compute_rewards(
        ...
        lfinger_dist = kinova_lfinger_pos[:, 2] - drawer_grasp_pos[:, 2]
        rfinger_dist = drawer_grasp_pos[:, 2] - kinova_rfinger_pos[:, 2]
