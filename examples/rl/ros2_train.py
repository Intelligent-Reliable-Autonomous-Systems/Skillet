...
"""Script to train RL agent with RSL-RL in ROS2."""
...
parser.add_argument("--seed", type=int, default=NoneF, help="Seed used for the environment")
...
def main(env_cfg, agent_cfg: RslRlBaseRunnerCfg):
    ...
    env = SkillROS2EnvWrapper if args_cli.skill else ROS2SkilletEnv[BxN_Obs, BxM_Action](env)
