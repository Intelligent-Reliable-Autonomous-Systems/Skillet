...
from skillet.agents import PlanningAgent, SelectedSkill
...
def main() -> None:
    ...
    pick_block_skill = PickBlockSkill(scene, pick_skill, vis_target_pos=visualizer.set_target_pos, dtype="str")
    place_block_skill = PlaceBlockSkill(scene, place_skill, vis_target_pos=visualizer.set_target_pos, dtype="str")
    ...
    block_task = "skillet/scene/abstract/assets/3-block-table.problem.pddl"
